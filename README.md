...
This lightning web component allows you to alter the out of the box Salesforce CSS within nearly any element in the page. All you have to do is find a good css selector, write the css, and then create a custom metadata setting record to represent your hawt new style updates.   
...
If you would prefer to not install this via an unlocked package, use the "Deploy to Salesforce" button below to deploy the code to your org.
  ...
  <a align="center" href="https://githubsfdeploy.herokuapp.com?owner=Coding-With-The-Force&repo=salesforce-css-injector&ref=main">
